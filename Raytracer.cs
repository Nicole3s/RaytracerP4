...
namespace Template
{
    class Raytracer
    {
        ...
        public void Init()
        {
            ...
            scene.AddObject(new circle(new Vector2(80, 300), 10));
            ...
            scene.AddLightsource(new AreaLight(new Vector2(50, screen.height/2), new Vector2(70, screen.height / 3 * 2.5f), 6, 0.6f, 0.0f, 0.4f, 10, null));
        }
        public void Tick()
        {
            screen.Clear(0);
